// Full world country list — ISO-3166-1 alpha-2, dial code, name.
// Sorted alphabetically by name. Flag rendered via flag-icons CSS (FlagIcon component).
export const COUNTRIES = [
  ...
  { code: 'GS', name: 'South Georgia',                    dial: '+500'  },
  ...
  { code: 'VI', name: 'US Virgin Islands',                dial: '+1-340'},
